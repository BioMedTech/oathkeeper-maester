...
import (
	...
	rulesv1alpha1 "github.com/biomedtech/oathkeeper-maester/api/rules/v1alpha1"
	versioned "github.com/biomedtech/oathkeeper-maester/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/biomedtech/oathkeeper-maester/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/biomedtech/oathkeeper-maester/pkg/generated/listers/rules/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RulesV1alpha1().Rules(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RulesV1alpha1().Rules(namespace).Watch(options)
			},
		},
		&rulesv1alpha1.Rule{},
		resyncPeriod,
...
func (f *ruleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rulesv1alpha1.Rule{}, f.defaultInformer)
}
